...
public abstract class CoreServiceImpl<P extends BasePO, D extends BaseDP, M extends BaseMapper<P>> extends ServiceImpl<M, P> implements CoreService<D, P>, DataConvert<P, D> {
